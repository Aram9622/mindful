    ...
    <div class="split">
        <aside class="image-panel">
            <div class="image-inner">
                <img src="../../images/staff/Svetlana.png" alt="Svetlana Nikoghosyan" />
            </div>
        </aside>
        <main class="content-panel">
            <div class="card">
                ...
                <section class="section">
                    ...
                    <dl>
                        <dt>2023 – Present</dt>
                        <dd>Clinical Psychologist<br>IU Internationale Hochschule, Clinical Psychology — Germany</dd>
                        <dt>2021 – 2025</dt>
                        <dd>Clinical Psychologist<br>Yerevan State University, Clinical Psychology and Psychotherapy</dd>
                        <dt>2017 – 2021</dt>
                        <dd>Psychologist<br>Yerevan State University, Psychology</dd>
                    </dl>
                </section>
                ...
                <section class="section">
                    ...
                    <dl>
                        ...
                        <dt>2022 – Present</dt>
                        <dd>Independent practice — Conducting individual therapies</dd>
                    </dl>
                </section>
                ...
                <section class="section">
                    ...
                    <dl>
                        <dt>2024 – Present</dt>
                        <dd>Cognitive-Behavioral Therapy<br>Applied Psychology Center, YSU</dd>
                        <dt>2023 – 2025</dt>
                        <dd>Art Therapy<br>Applied Psychology Center, YSU</dd>
                    </dl>
                </section>
                ...
                <section class="section">
                    ...
                    <ul>
                        ...
                        <li>Identity crisis related to cultural belonging</li>
                        <li>Depression</li>
                        <li>Anxiety disorders</li>
                        <li>Post-Traumatic Stress Disorder (PTSD)</li>
                        <li>Narcissistic and Obsessive-Compulsive Personality Disorders</li>
                    </ul>
                </section>
                ...
                <section class="section">
                    ...
                    <div class="footer">20,000 AMD</div>
                </section>
            </div>
        </main>
    </div>
