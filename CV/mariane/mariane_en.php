    ...
    <div class="split">
        <aside class="image-panel">
            <div class="image-inner">
                <img src="../../images/staff/Mariane.jpg" alt="Mariane Abrahamyan" />
            </div>
        </aside>
        <main class="content-panel">
            <div class="card">
                <header>
                    ...
                    <div>
                        <h1>Mariane Abrahamyan</h1>
                        <div class="subtitle">Clinical Psychologist-Psychotherapist</div>
                        <div class="subtitle">Consultation Fees: Individual 20,000 AMD / Couple 30,000 AMD</div>
                    </div>
                </header>
                ...
                <section class="section">
                    ...
                    <dl>
                        <dt>2021 - 2023</dt>
                        <dd>Clinical Psychologist, Master’s Degree, Department of Psychology, Faculty of Philosophy and Psychology, YSU</dd>
                        <dt>2017 - 2021</dt>
                        <dd>Psychologist, Department of Psychology, Faculty of Philosophy and Psychology, YSU</dd>
                    </dl>
                </section>
                ...
                <section class="section">
                    ...
                    <dl>
                        <dt>2024 - Present</dt>
                        <dd>Mindful Mental Health Counseling Center — Clinical Psychologist-Psychotherapist</dd>
                        <dt>2023 - Present</dt>
                        <dd>MHS Psychological Services Center — Clinical Psychologist-Psychotherapist</dd>
                        <dt>2022 - 2023</dt>
                        <dd>Davidyants Polyclinics — Clinical Psychologist-Psychotherapist</dd>
                        <dt>2021 - 2024</dt>
                        <dd>Rebalance Dietological Clinic — Clinical Psychologist-Psychotherapist</dd>
                    </dl>
                </section>

                <section class="section">
                    <h2>Psychotherapeutic Trainings</h2>
                    <dl>
                        <dt>2023</dt>
                        <dd>Clinical Psychology from Within — Libra Psychological Center</dd>
                        <dt>2023</dt>
                        <dd>Seminar “Basics of Sexology for Mental Health Professionals” — MHS Psychological Services Center</dd>
                        <dt>2023</dt>
                        <dd>Eye Movement Desensitization and Reprocessing Therapy — Armenian EMDR Association</dd>
                        <dt>2023</dt>
                        <dd>Brainspotting — YSU Center for Applied Psychology</dd>
                        <dt>2023</dt>
                        <dd>Couples Counseling: Humanistic and Cognitive Behavioral Approaches — “Kenats Tsar” Psychological Services Center</dd>
                        <dt>2023</dt>
                        <dd>Acceptance and Commitment Therapy — MHS Psychological Services Center</dd>
                        <dt>2023</dt>
                        <dd>“Psychiatry for Psychologists: Theory and Practice” — MHS mental health service</dd>
                        <dt>2022 - 2023</dt>
                        <dd>Cognitive Behavioral Therapy — YSU Center for Applied Psychology</dd>
                        <dt>2018 - 2019</dt>
                        <dd>Art Therapy — AYG Psychological Services Center</dd>
                    </dl>
                </section>
                ...
                <section class="section">
                    ...
                    <ul>
                        ...
                        <li>Eating behavior disorders</li>
                        <li>Post-traumatic stress disorder (PTSD)</li>
                        <li>Complex PTSD</li>
                        <li>Interpersonal problems: unhealthy relationships within the family and/or with a partner</li>
                        <li>Difficulties in socialization and communication</li>
                    </ul>
                </section>
