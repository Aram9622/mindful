    ...
    <div class="split">
        <aside class="image-panel">
            <div class="image-inner">
                <img src="../../images/staff/Hermine.jpg" alt="Hermine Hakobyan" />
            </div>
        </aside>
        <main class="content-panel">
            <div class="card">
                <header>
                    ...
                    <div>
                        <h1>Hermine Hakobyan</h1>
                        <div class="subtitle">Psychologist-Psychotherapist</div>
                        <div class="subtitle">Consultation Fee: 20,000 AMD</div>
                    </div>
                </header>
                ...
                <section class="section">
                    ...
                    <dl>
                        <dt>1999–2004</dt>
                        <dd>ASPU, Faculty of Pedagogy and Psychology — Military Psychologist</dd>
                    </dl>
                </section>
                ...
                <section class="section">
                    ...
                    <dl>
                        <dt>2024 - Present</dt>
                        <dd>Mindful Mental Health Counseling — Psychologist-Psychotherapist</dd>
                        <dt>2008 - Present</dt>
                        <dd>“Avan” Mental Health Center — Psychologist</dd>
                        <dt>2018 - 2019</dt>
                        <dd>Sigma-Med Outpatient Narcological Services Center — Psychologist-Consultant</dd>
                        <dt>2004 - 2007</dt>
                        <dd>“Mkhitar Gosh” Armenian-Russian International University — Lecturer</dd>
                    </dl>
                </section>
                ...
                <section class="section">
                    ...
                    <dl>
                        <dt>2024 - 2025</dt>
                        <dd>Schema Therapy — Moscow Institute of Schema Therapy, Russia</dd>
                        <dt>2010</dt>
                        <dd>Cognitive-Behavioral Therapy — Armenian State Pedagogical University, Armenia</dd>
                    </dl>
                </section>
                ...
                <section class="section two-cols">
                    ...
                    <div>
                        <h2>Memberships</h2>
                        <ul>
                            <li>Member of the Armenian Psychiatric Association</li>
                            <li>Has participated in numerous conferences and trainings in Armenia</li>
                        </ul>
                    </div>
                </section>
