    ...
    <div class="split">
        <aside class="image-panel">
            <div class="image-inner">
                <img src="../../images/staff/Lilith.JPG" alt="Lilit Khachatryan" />
            </div>
        </aside>
        <main class="content-panel">
            <div class="card">
                <header>
                    ...
                    <div>
                        <h1>Lilit Khachatryan</h1>
                        <div class="subtitle">Social Media Content Creator — "Mindful" Mental Health Counseling Center</div>
                    </div>
                </header>

                <section class="section">
                    <h2>About</h2>
                    <p>Meet <strong>Lilit Khachatryan</strong>, the Social Media Content Creator at <em>"Mindful" Mental Health Counseling Center</em>.</p>
                    <p>Our posts are created thanks to Lilit's creative thinking and visual taste.</p>
                    <p>She ensures "Mindful's" presence on digital platforms.</p>
                </section>
            </div>
        </main>
    </div>
