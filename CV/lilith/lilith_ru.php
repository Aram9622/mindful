    ...
    <div class="split">
        <aside class="image-panel">
            <div class="image-inner">
                <img src="../../images/staff/Lilith.JPG" alt="Лилит Хачатрян" />
            </div>
        </aside>
        <main class="content-panel">
            <div class="card">
                <header>
                    ...
                    <div>
                        <h1>Лилит Хачатрян</h1>
                        <div class="subtitle">Создатель контента для социальных сетей — консультационный центр психического здоровья «Майндфул»</div>
                    </div>
                </header>

                <section class="section">
                    <h2>Обо мне</h2>
                    <p>Знакомьтесь с <strong>Лилит Хачатрян</strong> — создателем контента для социальных сетей консультационного центра психического здоровья «Майндфул».</p>
                    <p>Наши публикации создаются благодаря творческому мышлению и визуальному вкусу Лилит.</p>
                    <p>Она обеспечивает присутствие «Майндфула» на цифровых платформах.</p>
                </section>
            </div>
        </main>
    </div>
