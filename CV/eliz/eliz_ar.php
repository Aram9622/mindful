...
{ ob_start(); ?>
    ...
    <head>
        ...
        <title>Էլիզա Պողոսյան — Mindful</title>
        <style>
            ...
            *{box-sizing:border-box}
            ...
            .avatar{width:92px;height:92px;border-radius:12px;overflow:hidden;display:flex;align-items:center;justify-content:center;background:linear-gradient(180deg,var(--accent),#6aa6e6);}
    ...
    <div class="split">
        <aside class="image-panel">
            <div class="image-inner">
                <img src="../../images/staff/Eliz.jpg" alt="Էլիզա Պողոսյան" />
            </div>
        </aside>
        <main class="content-panel">
            <div class="card">
                <header>
                    ...
                    <div>
                        <h1>Էլիզա Պողոսյան</h1>
                        <div class="subtitle">«Մայնդֆուլ» հոգեկան առողջության խորհրդատվական կենտրոն</div>
                        <div class="subtitle">Ադմինիստրատոր</div>
                    </div>
                </header>

                <section class="section">
                    <h2>Իմ մասին</h2>
                    <p>Ծանոթացեք, Էլիզա Պողոսյանն է, «Մայնդֆուլ» հոգեկան առողջության խորհրդատվական կենտրոնի ադմինիստրատորը։</p>
                    <p>Նա է համակարգում մեր աշխատանքը, պատասխանում Ձեր հարցերին, կատարում ամրագրումները։</p>
                    <p>Կենտրոնի անխափան աշխատանքի հիմնական պատասխանատուն Էլիզան է։</p>
                </section>
            </div>
        </main>
    </div>
