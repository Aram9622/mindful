    ...
    <div class="split">
        <aside class="image-panel">
            <div class="image-inner">
                <img src="../../images/staff/Eliz.jpg" alt="Элиза Погосян" />
            </div>
        </aside>
        <main class="content-panel">
            <div class="card">
                <header>
                    ...
                    <div>
                        <h1>Элиза Погосян</h1>
                        <div class="subtitle">Администратор — Консультационный центр психического здоровья «Майндфул»</div>
                    </div>
                </header>

                <section class="section">
                    <h2>О специалисте</h2>
                    <p>Знакомьтесь с <strong>Элизой Погосян</strong> — администратором <em>консультационного центра психического здоровья «Майндфул»</em>.</p>
                    <p>Она координирует нашу работу, отвечает на ваши вопросы и осуществляет запись на приём.</p>
                    <p>Элиза является главным ответственным за бесперебойную и слаженную работу центра.</p>
                </section>
            </div>
        </main>
    </div>
